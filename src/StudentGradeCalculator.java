 ...
 /* Description:
            This program calculates the total marks,average percentage and assigns a grade based on the marks
            obtained in each subject(out of 100).It takes input for the number of subjects and marks obtained
            in each subject from the user. The program validates the input and provides results including the
            total marks, average percentage, and grade. ANSI escape codes are used for text formatting to
    ...
    public class StudentGradeCalculator {
        ...
        public static void main(String[] args) {
            ...
            try{
                ...
                System.out.println("\n" + ANSI_BOLD + "________Results________" + ANSI_RESET);
                ...
                System.out.println(ANSI_BOLD + "_______________________"+ANSI_RESET);
